...
static const _GPT_Request_type_support_symbol_names_t _GPT_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpt_interface, srv, GPT_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpt_interface, srv, GPT_Request)),
  }
};
...
{
  return &::gpt_interface::srv::rosidl_typesupport_cpp::GPT_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gpt_interface, srv, GPT_Request)() {
  return get_message_type_support_handle<gpt_interface::srv::GPT_Request>();
}
...
static const _GPT_Response_type_support_symbol_names_t _GPT_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpt_interface, srv, GPT_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpt_interface, srv, GPT_Response)),
  }
};
...
{
  return &::gpt_interface::srv::rosidl_typesupport_cpp::GPT_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gpt_interface, srv, GPT_Response)() {
  return get_message_type_support_handle<gpt_interface::srv::GPT_Response>();
}
...
static const _GPT_type_support_symbol_names_t _GPT_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpt_interface, srv, GPT)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpt_interface, srv, GPT)),
  }
};
...
{
  return &::gpt_interface::srv::rosidl_typesupport_cpp::GPT_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, gpt_interface, srv, GPT)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<gpt_interface::srv::GPT>();
}
